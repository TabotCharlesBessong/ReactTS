			...
			>
				...
				<div className="z-10 mt-32 md:basis-3/5">
					...
					>
						<div className="relative">
							<div className="before:absolute before:-top-20 before:-left-20 before:z-[-1] md:before:content-evolvetext">
								<img alt="home-page-text" src={images.homeT} />
							</div>
						</div>
					...
					>
						...
						<AnchorLink
							className="text-sm font-bold text-primary-500 underline hover:text-secondary-500 transition duration-300 ease-linear"
              ...
              md:ml-40 md:mt-16 md:justify-items-end"
				>
					<img alt="home-pageGraphic" src={images.homeG} />
				</div>
			</motion.div>
